...
@section('content')
    ...
    <div>
        <form method="post"
            action="{{ route(str_replace('edit', 'update', Route::currentRouteName()), $discount_code) }}">
            @method('put')
            @csrf
            <div class="row mt-4 ">
                @if (isset($categories))
                    <div class="form-group col-6">
                        ...
                        <input name="code" value="{{ old('code') ?? $discount_code->code }}" type="text"
                        ...
                        <select class="form-control {{ $errors->has('category_id') ? 'is-invalid' : '' }}"
                            ...
                            @foreach ($categories as $category)
                                <option value={{ $category->id }}
                                    {{ old('category_id') == $category->id || $discount_code->category_id == $category->id ? 'selected' : '' }}>
            ...
            <div class="row mt-4 ">
                <div class="form-group col-6">
                    ...
                    <input name="start_date" value="{{ old('start_date') ?? $discount_code->start_date }}" type="date"
                ...
                <div class="form-group col-6">
                    ...
                    <input name="end_date" type="date" value="{{ old('end_date') ?? $discount_code->end_date }}"
                        type="number" class="form-control {{ $errors->has('end_date') ? 'is-invalid' : '' }}"
            ...
            <div class="row mt-4 ">
                <div class="form-group col-6">
                    ...
                    <input name="amount" value="{{ old('amount') ?? $discount_code->amount }}" type="number" min="1"
                ...
                <div class="form-group col-6">
                    ...
                    <input name="percent" type="number" value="{{ old('percent') ?? $discount_code->percent }}"
                        type="number" min="0" class="form-control {{ $errors->has('percent') ? 'is-invalid' : '' }}"
            ...
            <div class="row mt-4 ">
                <div class="form-group col-6">
                    ...
                    <input name="from_price" value="{{ old('from_price') ?? $discount_code->from_price }}" type="number"
                        min="1000" step="1000" class="form-control {{ $errors->has('from_price') ? 'is-invalid' : '' }}"
                ...
                <div class="form-group col-6">
                    ...
                    <input name="max_price" type="number" min="1000" step="1000"
                        value="{{ old('max_price') ?? $discount_code->max_price }}" type="number"
